...
//        final Intent[] intent = new Intent[1];
        if(sharedPrefrenceHelper.getBoolean(Constants.LOGINSTATUS)) {
            Log.i(TAG, "lanchApp: orderId==>"+sharedPrefrenceHelper.getString(Constants.ORDERID));
            DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReference().child("DriverData").child(sharedPrefrenceHelper.getString(Constants.DRIVERNAME));
            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    Log.i(TAG, "onDataChange: orderId==>"+String.valueOf(dataSnapshot.child("Current orderId").getValue()));
                    Intent intent;
                    if(String.valueOf(dataSnapshot.child("Current orderId").getValue()).equals("")){
...
//            if (sharedPrefrenceHelper.getString(Constants.ORDERID)!=null) {
//                intent[0] = new Intent(SplashActivity.this, MainActivity.class);
//            } else {
//                intent[0] = new Intent(SplashActivity.this, OderActivity.class);
//            }
        }else{
